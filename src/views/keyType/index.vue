...
import Table from "@views/keyType/components/Table.vue"
import Header from "@views/keyType/components/Header.vue"
import { Add } from "@vicons/ionicons5"
import { VisibleDrawer } from "@/@types/visible.ts"
import Drawer from "@views/keyType/components/Drawer.vue"
import { useKeyTypeStore } from "@stores/modules/keyType"

const keyTypeStore = useKeyTypeStore()
const handleClickAdd = () => {
    keyTypeStore.setVisibleDrawer(VisibleDrawer.Add)
}
</script>
